...
@section('subtitle', 'Add a new contact group')
        ...
        <div class="space-y-6 max-w-2xl">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-purple-200 focus:border-purple-500">{{ old('description') }}</textarea>
            </div>
